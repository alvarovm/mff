...
twobody_ff_T = cPickle.load(f, encoding="latin-1")
f.close()

f = open(theano_dir + 'G2b_ms.save', 'rb')
twobody_ef_T = cPickle.load(f, encoding="latin-1")
f.close()

f = open(theano_dir + 'S2b_ms.save', 'rb')
twobody_ee_T = cPickle.load(f, encoding="latin-1")
f.close()

f = open(theano_dir + 'H3b_ms.save', 'rb')
threebody_ff_T = cPickle.load(f, encoding="latin-1")
f.close()

f = open(theano_dir + 'G3b_ms.save', 'rb')
threebody_ef_T = cPickle.load(f, encoding="latin-1")
f.close()

f = open(theano_dir + 'S3b_ms.save', 'rb')
threebody_ee_T = cPickle.load(f, encoding="latin-1")
f.close()
