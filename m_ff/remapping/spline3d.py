...
from mlfmapping import _tricub


class TriCubicSpline(object):
    ...
    def _ev_energy(self, xi, yi, zi):
        ...
        return self._ev_energy_fast(x, y, z)

    def _ev_forces_fast(self, x, y, z):
    ...
    def _ev_forces(self, xi, yi, zi):
        ...
        return self._ev_forces_fast(x, y, z)

    def _ev_all_fast(self, x, y, z):
    ...
    def _ev_all(self, xi, yi, zi):
        ...
        return self._ev_all_fast(x, y, z)


class Spline3D(TriCubicSpline):
    ...
    def ev_energy(self, rs):
        ...
        # Interpolation
        val = self._ev_energy(r1, r2, np.arccos(cosphi))

        return np.sum(val, axis=0)

    def ev_energy_fast(self, rs):
        # Vectorize
        r1, r2, r1_hat, r2_hat, cosphi = self.vectorize(rs)

        # Interpolation
        val = self._ev_energy_fast(r1, r2, np.arccos(cosphi))
    ...
    def ev_forces(self, rs):
        ...
        # Interpolation
        de_dr1, de_dr2, de_dphi = self._ev_forces(r1, r2, np.arccos(cosphi))
    ...
    def ev_forces_fast(self, rs):
        # Vectorize
        r1, r2, r1_hat, r2_hat, cosphi = self.vectorize(rs)

        # Interpolation
        de_dr1, de_dr2, de_dphi = self._ev_forces_fast(r1, r2, np.arccos(cosphi))
    ...
    def ev_all(self, rs):
        ...
        # Interpolation
        val, de_dr1, de_dr2, de_dphi = self._ev_all(r1, r2, np.arccos(cosphi))
    ...
    def ev_all_fast(self, rs):
        # Vectorize
        r1, r2, r1_hat, r2_hat, cosphi = self.vectorize(rs)

        # Interpolation
        val, de_dr1, de_dr2, de_dphi = self._ev_all_fast(r1, r2, np.arccos(cosphi))
